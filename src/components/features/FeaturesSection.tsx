    ...
    <section id="features" className="container px-4 py-24">
      ...
      <div className="max-w-2xl mb-20">
        <h2 className="text-5xl md:text-6xl font-normal mb-6 tracking-tight text-left">
          Magic Formula
          <br />
          <span className="text-gradient font-medium">Investment Tools</span>
        </h2>
        <p className="text-lg md:text-xl text-gray-400 text-left">
          Professional-grade value investing tools based on Joel Greenblatt's proven Magic Formula strategy for consistent market outperformance.
        </p>
      </div>
